...
class PositiveIntegerTest extends TestCase
{
	...
	{
        $field = new Validations\PositiveInteger(
	...
	public function testNegativeIntegerThrowsException()
	{
        ...
        $field = new Validations\PositiveInteger(
            new Validations\AlwaysValid(
                new Validations\DefaultRequest(array("number" => $value))
            ),
            "number"
        );
        $this->expectException(Validations\ValidationException::class);
 	...
 	public function testValidIntegerReturnsTrue()
	{
        ...
        $this->assertTrue($field->validate(), "Validating a positive number [$value] should return true");
    }
